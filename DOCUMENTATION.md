...
| :--- | :--- | :--- |
| Manual | [`TopDownMovement`](https://github.com/ChillCube/TopDownMovement/blob/main/DOCUMENTATION.md) | [Repo](https://github.com/ChillCube/TopDownMovement) |
...
| **enable_walking** | `bool` | `true` | Allow the character to walk via input |
